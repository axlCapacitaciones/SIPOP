...
<html lang="en">
  <head>
    ...
    <title>SIOM Dashboard - Manage Users</title>
    <meta name="description" content="">
    <meta name="author" content="AXL Capacitaciones">
    <!-- 
    SIOM Template
    ...
    <link href="css/siom-style.css" rel="stylesheet">
  ...
  <body>  
    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            <li><a href="index.html"><i class="fa fa-home fa-fw"></i>SIOM</a></li>
            <li><a href="proyecto.html" class="active"><i class="fa fa-users fa-fw"></i>Proyecto</a></li>
            <li><a href="preferences.html"><i class="fa fa-sliders fa-fw"></i>Formulario</a></li>
            <li><a href="login.html"><i class="fa fa-eject fa-fw"></i>Cerrar Sesion</a></li>
          </ul>  
        </nav>
      </div>
      <!-- Main content --> 
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="index.html">SIOM</a></li>
                <li><a href="proyecto.html" class="active">Proyecto</a></li>
                <li><a href="preferences.html">Formulario</a></li>
        ...
        <div class="templatemo-content-container">
                ...
                <tbody>
                    ...
                    <?
                      ...
                      while ($row = $result->fetch_assoc()) {
                        echo '<tr>';
                          echo '<td>'.$row["part_line"].'</td>';
                          echo '<td>'.$row["part_proy"].'</td>';
                          echo '<td>'.$row["part_clav"].'</td>';
                          echo '<td><a href="" class="templatemo-edit-btn">Edit</a></td>';
                          echo '<td><a href="" class="templatemo-link">Action</a></td>';
                          echo '<td><a href="" class="templatemo-link">Delete</a></td>';
                          echo '<td><a href="" class="templatemo-link">Imagen</a></td>';
                          echo '<td><a href="" class="templatemo-link">Status</a></td>';
                        echo '</tr>';
                      }
                      ?>
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2026 SIOM 
            | Design: AXL Capacitaciones</p>
          </footer>         
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript" src="js/siom-script.js"></script>      <!-- Templatemo Script -->
    <script>
